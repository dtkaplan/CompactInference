...
sds_table(Galton, show_n = 10,
          caption="Figure 2.1: The `Galton` data frame containing Galtons measurements of 898 adult children.") %>%
  knitr::asis_output()
```
...
sds_table(Punnett, caption = "Figure 2.3: Punnet's data in a contemporary format")
```

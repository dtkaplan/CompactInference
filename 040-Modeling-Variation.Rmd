...
```{r fig-4-4, echo = FALSE, fig.cap="Figure  4.4: The red function is a bad match to the data. At heights below 63 inches, almost all the data points are above the red line."}
gf_jitter(height ~ mother, data = Galton, alpha = 0.15) %>%
...
```{r galton-logistic, echo=FALSE, fig.cap = "Figure 4.5: A model with an indicator response variable and a numerical explanatory variable."}

...
```{r galton-0, echo=FALSE, fig.cap="Figure 1: Galton's height measurements with height as the response variable and sex as the explanatory variable. The model gives a single output for each level  of  the explanatory variable."}
...
```{r galton-2, echo=FALSE, fig.cap="Child's height versus the mother's height. A conventional form of model is a straight line."}
...
```{r punnett-1, echo=FALSE, fig.cap = "Punnett's data from cross breeding peas, along with a model of flower color versus pollen shape."}
...
```{r galton-logistic, echo=FALSE, fig.cap = "A model with a binary categorical response variable and a numerical explanatory variable."}

...
```{r fig6-1-redux,echo=FALSE, cache=TRUE, fig.cap="Figure 7.1: A reproduction of Figure 6.1(a) with annotations to show the effect size."}
P1 %>%
  gf_segment(64.1 + 69.2 ~ 1.5 + 1.5, color="red", arrow = grid::arrow(ends="both", length = unit(5, "point"))) %>%
  gf_label(66.5 ~ 1.5, label="5.1 inches.",
           color = "red",
...
```{r fig6-2-redux,echo=FALSE, cache=TRUE, fig.cap="Figure 7.2: A reproduction of Figure 6.1(b) with annotations to show the effect size."}
P2 %>%
  gf_vline(xintercept=c(60,68), color  = "red") %>%
  gf_point(65.5  ~ 60, color = "red", size = 2) %>%
  gf_point(68 ~ 68, color  = "red", size=2) %>%
  gf_segment(64 + 64  ~ 60 + 68,  color="red", 
             arrow = grid::arrow(ends="both", length = unit(5, "point"))) %>%
  gf_segment(65.5 + 68 ~ 67.8 + 67.8,  color = "red", arrow = grid::arrow(ends="both", length = unit(5, "point"))) %>%
  gf_label(64 ~ 64, label="run =  8 inches",
           color = "red",
           nudge_y  = -0.5, vjust = 1) %>%
  gf_label(66.5 ~ 68, label="rise=2.5 inches",
           color = "red",
           nudge_x  = 0.0, hjust = 0)
